...
public class ConcentratePaymentLinstener implements MessageListenerConcurrently{
	...
	private static final String KEY = "CONCENTRATEPAYMENT:";
	...
	public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
		...
		for (MessageExt msg : msgs) {
			if (msg.getTopic().equals(RESOURCE.getString("ConcentratePaymentOrder"))) {
				...
				if(orderTagsEnum==OrderTagsEnum.CONCENTRATE_PAYMENT_REALTIME) {//实时代付
						...
						try {
							resultBean =  null;//insteadPayOrderService.createRealTimeOrder(orderBean);
