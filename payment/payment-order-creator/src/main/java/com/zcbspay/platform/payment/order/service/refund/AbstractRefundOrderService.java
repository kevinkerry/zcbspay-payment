 ...
 * 
 */
package com.zcbspay.platform.payment.order.service.refund;
...
import com.zcbspay.platform.payment.order.refund.bean.RefundOrderBean;
...
public abstract class AbstractRefundOrderService implements OrderService,CheckOfServcie<RefundOrderBean>{
	...
	public void checkOfMerchantAndCoopInsti(RefundOrderBean orderBean)
        ...
        PoMemberBean pojoMember = memberService.getMemberByMemberId(orderBean.getMerId(), null);
        //校验商户会员信息 
