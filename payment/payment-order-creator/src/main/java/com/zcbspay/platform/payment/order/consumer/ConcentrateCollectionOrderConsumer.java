 ...
 * @author guojia
 * @version
 * @date 2017年3月13日 上午11:28:02
 * @since
 */
@Service
public class ConcentrateCollectionOrderConsumer  implements  ApplicationListener<ContextRefreshedEvent>{
	...
	public void startConsume() throws InterruptedException, MQClientException {
		...
		consumer.subscribe(RESOURCE.getString("concentrate.collection.order.subscribe"), subExpression);
		consumer.registerMessageListener(concentrateCollectionListener);//在监听器中实现创建order
		consumer.start();
