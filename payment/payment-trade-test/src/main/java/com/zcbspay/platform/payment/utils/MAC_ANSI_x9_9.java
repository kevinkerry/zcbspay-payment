...
public class MAC_ANSI_x9_9 {
	...
	public static void main(String[] args) throws Exception {
		...
		String data = "3310062091201705100310015133101103016228480018543668976           guoaji                                                      3310130601213582310310001               RMB0000000001000000000             0000000000003                                50046";

		String macCode = MAC(masterKey, "0000000000000000", data, ASC, 1);
